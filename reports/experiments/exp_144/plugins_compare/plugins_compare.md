...
| `methods.mime_prototypes.1.constructor.descriptor.setterSource` | MISSING | The property exists in the Real Browser baseline but is absent from Playwright. |
