...
Output: `D:\bot_monitoring_cemeru\reports\experiments\exp_019\environment`
...
**Cloudflare or target-site behavior** (Medium confidence)

Repeat from a permitted network and compare HTTP/CF headers; do not infer from fingerprint similarity.
