...
|---|---:|---:|---:|
| `experiment:exp_025` | 0.226 | 0.392 | 0.397 |
| `experiment:exp_023` | 0.226 | 0.377 | 0.396 |
| `experiment:exp_024` | 0.226 | 0.360 | 0.397 |
| `feature:category:other` | 0.212 | 0.264 | 0.310 |
| `module:other` | 0.212 | 0.264 | 0.310 |
| `property:navigator.language` | 0.049 | 0.155 | 0.268 |
| `task:OPT-012` | 0.003 | 0.138 | 0.308 |
| `feature:category:navigator` | 0.092 | 0.138 | 0.235 |
| `module:navigator` | 0.092 | 0.138 | 0.235 |
| `property:navigator.platform` | 0.095 | 0.107 | 0.231 |
| `recommendation:review_the_other_surface_for_value_descriptor_prototype_and_cross_property_consistency` | 0.132 | 0.068 | 0.269 |
...
| `task:OPT-001` | 0.006 | 0.052 | 0.310 |

## Clusters

Connected components: **35**; strongly connected groups: **2**.
