...
|---|---:|---:|---:|
| `feature:category:other` | 0.238 | 0.534 | 0.322 |
| `module:other` | 0.238 | 0.534 | 0.322 |
| `sprint:2` | 0.086 | 0.319 | 0.246 |
| `feature:category:navigator` | 0.103 | 0.307 | 0.243 |
| `module:navigator` | 0.103 | 0.307 | 0.243 |
| `sprint:3` | 0.069 | 0.290 | 0.242 |
| `sprint:4` | 0.087 | 0.265 | 0.243 |
| `property:navigator.platform` | 0.107 | 0.240 | 0.215 |
| `sprint:1` | 0.010 | 0.120 | 0.225 |
| `property:navigator.language` | 0.054 | 0.093 | 0.205 |
| `property:webgl.aliased_point_size_range[1]` | 0.004 | 0.081 | 0.203 |
| `task:OPT-207` | 0.001 | 0.080 | 0.213 |
| `property:canvas.hash` | 0.002 | 0.050 | 0.273 |
| `property:canvas.length` | 0.002 | 0.050 | 0.273 |
| `task:OPT-020` | 0.001 | 0.048 | 0.245 |

## Clusters

Connected components: **16**; strongly connected groups: **3**.
